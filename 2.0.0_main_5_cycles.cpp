...
void loop()
{
    ...
    //dut1.set_channel_UI ( read_adc_channel(1,0));
    // dut1.set_channel_MI ( read_adc_channel(1,1));
    // dut1.set_channel_I ( read_adc_channel(1,2));
    // dut1.set_channel_PWR_DUT ( read_adc_channel(1,4));

    // dut2.set_channel_UI ( read_adc_channel(1,5));
    dut2.set_channel_MI ( read_adc_channel(1,6));
    // dut2.set_channel_I ( read_adc_channel(1,7));
    // dut2.set_channel_PWR_DUT ( read_adc_channel(2,1));

    // dut3.set_channel_UI ( read_adc_channel(2,2));
    // dut3.set_channel_MI ( read_adc_channel(2,3));
    // dut3.set_channel_I ( read_adc_channel(2,4));
    // dut3.set_channel_PWR_DUT ( read_adc_channel(2,6));

    // dut4.set_channel_UI ( read_adc_channel(3,0));
    // dut4.set_channel_MI ( read_adc_channel(3,1));
    // dut4.set_channel_I ( read_adc_channel(3,2));
    // dut4.set_channel_PWR_DUT ( read_adc_channel(3,4));

    // dut5.set_channel_UI ( read_adc_channel(3,5));
    // dut5.set_channel_MI ( read_adc_channel(3,6));
    // dut5.set_channel_I ( read_adc_channel(3,7));
    // dut5.set_channel_PWR_DUT ( read_adc_channel(4,1));

    // dut6.set_channel_UI ( read_adc_channel(4,2));
    // dut6.set_channel_MI ( read_adc_channel(4,3));
    // dut6.set_channel_I ( read_adc_channel(4,4));
    // dut6.set_channel_PWR_DUT ( read_adc_channel(4,6));

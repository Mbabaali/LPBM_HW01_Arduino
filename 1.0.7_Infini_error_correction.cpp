...
float conversion_channel_mA(long result)
{
  Serial.println("Fonction de conversion en mA\n");
  // Déclaration de la variable pour la tension
  ...
  Serial.print("tensionMaxLtc: "); 
  Serial.println(tensionMaxLtc);
  
  Serial.print("courant_max_LTC: ");
  Serial.println(courant_max_LTC);
  
  Serial.print("courantAmperParBit: "); 
  Serial.println(courantAmperParBit);
  ...
  Serial.print("courant_mA: "); Serial.println(courant_mA);
  // Retour de la valeur convertie
  return courant_mA;
}

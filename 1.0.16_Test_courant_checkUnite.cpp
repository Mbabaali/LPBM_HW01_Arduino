...
/***
 * Tableau pour pins de commande d'alimentation des DUTs
 ***/

int tableau_commande_alimentation_DUT[6] = {CMD_PWR_DUT1, CMD_PWR_DUT2, CMD_PWR_DUT3, CMD_PWR_DUT4, CMD_PWR_DUT5, CMD_PWR_DUT6};
...
void alimentation_des_DUTs(int etatAliementationDut)
{
    digitalWrite(CMD_PWR_DUT1, etatAliementationDut);
    digitalWrite(CMD_PWR_DUT2, etatAliementationDut);
    digitalWrite(CMD_PWR_DUT3, etatAliementationDut);
    digitalWrite(CMD_PWR_DUT4, etatAliementationDut);
    digitalWrite(CMD_PWR_DUT5, etatAliementationDut);
    digitalWrite(CMD_PWR_DUT6, etatAliementationDut);
}
